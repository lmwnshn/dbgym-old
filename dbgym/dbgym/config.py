...
class Config:
    ...
    TPCH_SF = None
    TPCH_DATA = None
    TPCH_WORKLOAD_SEED_START = None
    TPCH_WORKLOAD_SEED_END = None
...
if Config.HOSTNAME == "kapipad":
    ...
    Config.DSB_SF = 1
    Config.DSB_DATA = Path(f"/dsb_sf{Config.DSB_SF}").absolute()
    Config.TPCH_SF = 1
    Config.TPCH_DATA = Path(f"/tpch_sf{Config.TPCH_SF}").absolute()
    Config.TPCH_WORKLOAD_SEED_START = 15721
    Config.TPCH_WORKLOAD_SEED_END = 15730  # 15820  # 15730
    ...
    Config.TPCH_DATA = Path(f"/tpch_sf{Config.TPCH_SF}").absolute()
    Config.TPCH_WORKLOAD_SEED_START = 15721
    Config.TPCH_WORKLOAD_SEED_END = 15730
